...
#define SSID_NAME "Vodafone-A67514055"///Insert your wifi name" 
#define SSID_PASSWORD  "5wmbtbf67dztdh92" ///Insert your wifi password"
...
const char* writeAPIKey = "WPCX76VZK3J0F0FI"; ////API key of your channel
unsigned int SLEEP_TIME_MIN = 5; /*only minute sleep, max 60 minute */
int wifiCount = 0;
Agrumino agrumino;
...
void wifiSetup() {
  ...
  {
    delay(1000);
    Serial.print("WiFi count:"); Serial.print(wifiCount);
    wifiCount++;
    Serial.print(".");
